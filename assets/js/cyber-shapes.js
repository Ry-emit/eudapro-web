...
export function materials() {
  return {
    violet: new THREE.MeshStandardMaterial({ name: 'violet', color: 0x7d39eb, roughness: 0.34, metalness: 0.3 }),
    ...
    amber: new THREE.MeshStandardMaterial({ name: 'amber', color: 0xc6ff33, roughness: 0.38, metalness: 0.2 })
  };
}
